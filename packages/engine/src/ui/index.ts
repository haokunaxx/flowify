...
import { UIMode, UIComponentNotFoundError, TimeoutError } from '@flowify/core';
...
export class UIInteractionHandler {
  ...
  async handleUI(
    ...
    switch (config.mode) {
      ...
      case UIMode.CONFIRM:
        return this.handleConfirmUI(stepId, config);
      case UIMode.SELECT:
        return this.handleSelectUI(stepId, config);
      default:
        return {
          success: false,
          stepId,
